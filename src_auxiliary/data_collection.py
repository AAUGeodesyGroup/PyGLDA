...
class ERA5_land_monthly_mean:

    def __init__(self):
        self.__path = None
        pass

    def setPath(self, output_path='/media/user/My Book/Fan/ERA5/monthly'):
    ...
    def run(self):
        ...
        for yr in years:
            c.retrieve(
                ...
                str(self.__path / ("ERA5_land_monthly_TpTe_%04d.nc" % (int(yr))))
            )
...
def demo1():
    ERA5_download = ERA5_for_W3().setPath('/media/user/My Book/Fan/ERA5/Raw_W3').setDate(begin='2023-06', end='2024-05')
...
def demo3():
    demo=ERA5_land_monthly_mean().setPath()
    demo.run()
