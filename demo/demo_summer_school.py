...
def demo_DA_visualization(allow_pop_up=True):
    RDA.DA_visualization_basin_ensemble(allow_pop_up)
    RDA.DA_visualization_basin_DA(signal='TWS', allow_pop_up=allow_pop_up)
    RDA.DA_visulization_2Dmap(signal='trend', allow_pop_up=allow_pop_up)
    RDA.DA_visulization_2Dmap(signal='annual', allow_pop_up=allow_pop_up)
    pass
